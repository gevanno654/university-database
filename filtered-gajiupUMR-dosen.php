...
$filter = isset($_GET['filter']) ? $_GET['filter'] : 'above_umr';
...
<div class="container mt-5">
    ...
    <h1><i class="fas fa-database" style="color: #ff6600;"></i> Database Dosen<br>dengan Gaji di atas UMR</h1>

    <?php if(empty($filteredData)) : ?>
        <p>Data tidak tersedia</p>
    <?php else : ?>
        <p>UMR Surabaya = Rp 4.500.000</p>
        <p>Data Dosen dengan Gaji di atas UMR: </p>
        <hr>
