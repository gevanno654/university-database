<?php
ob_start();
$title = 'Gaji Dosen diatas rata-rata';
...
$filter = isset($_GET['filter']) ? $_GET['filter'] : 'above_avg';
...
<div class="container mt-5">
    ...
    <h1><i class="fas fa-database" style="color: #ff6600;"></i> Database Dosen<br>dengan Gaji di atas rata-rata</h1>

    <?php if(empty($filteredData)) : ?>
        <p>Data tidak tersedia</p>
    <?php else : ?>
        <p>Rata-rata gaji= Rp<?= number_format($mean, 0, ',', '.'); ?></p>
        <p>Data Dosen dengan Gaji di atas rata-rata: </p>
        <hr>
